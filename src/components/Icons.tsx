...
/** A compass: "show me the way", for the guided mode. */
export const Compass = ({ size = 14 }: { size?: number }) => (
  <svg width={size} height={size} {...base}>
...
/** Something arriving and coming to rest: shares landing in an account. */
