...
// Sole e luna disegnati, non scritti.
//
// Come caratteri erano "☀" e "☽", e su iOS il primo dei due viene promosso a
// emoji: sole giallo pieno accanto a una lunetta bianca sottile, due cose che
// non sembrano nemmeno della stessa famiglia. Un glifo che cambia stile da un
// sistema all'altro non e' un'icona, e per due forme cosi' semplici il disegno
// costa meno della sorpresa.
const Sole = () => (
      ...
      <div className="wrap">
        <div className="top-row">
          ...
          <Segmented<Tema>
            ...
            onChange={setTema}
            options={[
              { id: "light", label: <Sole />, title: t.header.themeLight },
              { id: "dark", label: <Luna />, title: t.header.themeDark },
